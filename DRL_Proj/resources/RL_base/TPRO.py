...
class TRPO:
	...
	def policy_learning(self, states, actions, old_action_dists, old_log_probs, advantage):
	...
	def update(self, transition_dict):
		...
		self.policy_learning(states, actions, old_action_dists, old_log_probs, advantage)
